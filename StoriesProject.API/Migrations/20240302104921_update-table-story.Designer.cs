...
namespace StoriesProject.API.Migrations
{
    ...
    [Migration("20240302104921_update-table-story")]
    partial class updatetablestory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Accountant", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.CoinLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.RoleAccountant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Story", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.TopicStory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Accountant", b =>
                {
                    b.HasOne("StoriesProject.API.Model.BaseEntity.CoinLog", "IdNavigation")
                        .WithOne("Accountant")
                        .HasForeignKey("StoriesProject.API.Model.BaseEntity.Accountant", "Id")
                        .IsRequired()
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Order", b =>
                {
                    b.HasOne("StoriesProject.API.Model.BaseEntity.Accountant", "CreatedByNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.OrderDetail", b =>
                {
                    b.HasOne("StoriesProject.API.Model.BaseEntity.Order", "Order")
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.RoleAccountant", b =>
                {
                    b.HasOne("StoriesProject.API.Model.BaseEntity.Accountant", "Account")
                    ...
                    b.HasOne("StoriesProject.API.Model.BaseEntity.Role", "Role")
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.Story", b =>
                {
                    ...
                    b.HasOne("StoriesProject.API.Model.BaseEntity.Accountant", "ModifiedByNavigation")
            ...
            modelBuilder.Entity("StoriesProject.API.Model.BaseEntity.TopicStory", b =>
                {
                    b.HasOne("StoriesProject.API.Model.BaseEntity.Story", "Story")
                        .WithMany("TopicStories")
                        .HasForeignKey("StoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TopicStory_Stories");

                    b.HasOne("StoriesProject.API.Model.BaseEntity.Topic", "Topic")
                        .WithMany("TopicStories")
